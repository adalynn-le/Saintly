...
<li>
  ...
  <span class="material-symbols-outlined iconsvg"  height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3">
book 
</span>
<span class="dropdownText">Topics Dashboard</span>
<a href="solvefire.html">
<span class="material-symbols-outlined">
local_fire_department
</span>
<span class="dropdownText">Solvefire\\(\\times\\)Saintly</span>
</li>
  ...
  const main = document.querySelector('main');
    if (sidebar.classList.contains('close')) {
      ...
      if (width > 768) {
        ...
        main.style.width = 'calc(100% - 190px)';
      } else {
